...
export const columns: ColumnDef<EmployeeModel>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      if (row.original.user) {
        ...
        return h('p', { class: 'font-medium text-nowrap' }, `${lastName} ${firstName}`)
      } else {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      if (row.original.user?.phoneNumber) {
        ...
        return h('p', { class: 'font-medium tabular-nums text-nowrap' }, phone)
      } else {
        return h('p', { class: 'italic text-muted-foreground text-nowrap' }, 'Not provided')
      }
    }
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return salary
        ? h('p', { class: 'font-medium text-nowrap' }, salary)
        : h('p', { class: 'italic text-muted-foreground text-nowrap' }, 'Not provided')
    }
  },
  {
    id: 'percent',
    ...
    cell: ({ row }) => {
      ...
      return percent
        ? h('p', { class: 'font-medium text-nowrap' }, `${percent}%`)
        : h('p', { class: 'italic text-muted-foreground text-nowrap' }, 'Not provided')
    }
  },
  {
